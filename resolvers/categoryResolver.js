    ...
    Mutation : {
        createCategory: async (_, { newCategory }) => {
            try {
                ...
                return { status : true, data: category, message: "Category created successfully" };
            } catch (error) {
                throw new Error(error.message);
            }
        },
        updateCategory: async (_, { id, categoryData }) => {
            try {
                ...
                return {  status : true, data: category, message: "Category updated successfully" };
            } catch (error) {
                throw new Error(error.message);
            }
        },
        toggleCategoryStatusById: async (_, { id }) => {
            try {
                ...
                return {  status : true, data: category, message: "Category status toggled successfully" };
            } catch (error) {
                throw new Error(error.message);
            }
        },
        deleteCategoryById: async (_, { id }) => {
            try {
                ...
                if (!category || (category.hasOwnProperty("deletedCount") && category.deletedCount === 0)) {
